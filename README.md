...
Es un patron de comportamiento el cual establece una relación de 1 a muchos, el objeto se encarga de notificar de forma automatica a sus dependencias si dicho objeto ha cambiado.
